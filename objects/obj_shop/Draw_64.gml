...
// Title (bordered)
draw_text_bordered(10, 5, "Clover's Supply Shop", c_white, c_black);
...
// Inventory title and list (bordered)
draw_text_bordered(170, 5, "Inventory", c_white, c_black);

var inv_y = 20;
for (var i = 0; i < array_length(global.inventory); i++) {
    var inv_item = global.inventory[i][0];
    var inv_amount = global.inventory[i][1];
