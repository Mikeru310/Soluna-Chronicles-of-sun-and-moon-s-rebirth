/// STEP EVENT — Side Quest 7 Giver (Commander Eld)
...
if (!marker_created)
{
    ...
    {
        if (parent_npc == other.id && quest_id == "side_quest_7")
            has_marker = true;
    }
    ...
    if (instance_exists(obj_player))
    {
        ...
        if (close && keyboard_check_pressed(ord("Z")))
        {
            if (!instance_exists(obj_textbox))
            {
                ...
                create_textbox("side_quest_7_after");
...
if (instance_exists(obj_player))
{
    ...
    if (pc && keyboard_check_pressed(ord("Z")) && interaction_cooldown <= 0)
    {
        ...
        if (global.side_quest_7_item_found && !global.side_quest_7_complete)
        {
            if (!instance_exists(obj_textbox))
            {
                text_x_offset = array_create(50,0);
                ...
                create_textbox("side_quest_7_complete_dialogue");
                obj_player.can_move = false;
            }

            global.side_quest_7_complete = true;
        ...
        && global.side_quest_7_given)
        {
            if (!instance_exists(obj_textbox))
            {
                ...
                create_textbox("side_quest_7_progress");
                obj_player.can_move = false;
            }
        ...
        if (!global.side_quest_7_given
        && !global.side_quest_7_started
        && !global.side_quest_7_item_found)
        {
            if (!instance_exists(obj_textbox))
            {
...
// ---------------------------------------------------------
if (global.side_quest_7_requested && !global.side_quest_7_given)
{
    scr_quest_add("side_quest_7",
        "Commander's Lost Flag",
        "Retrieve Commander Eld's command flag from Act 4 Area 3.",
        "Side Quest");

    scr_show_popup("New Side Quest Added!");

    global.side_quest_7_given     = true;
    global.side_quest_7_started   = true;
    global.side_quest_7_requested = false;
}
